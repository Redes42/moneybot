...
class Stages(StrEnum):
    ...
    ADD_PERSON_WITH_DEFAULT_COEFF_START = 'add_person_with_default_coeff_start'
    DEFINE_PERSON_NAME = 'define_person_name'
    DEFINE_ONLY_PERSON_NAME = 'define_only_person_name'
    ADD_PERSON_WITH_DEFAULT_COEFF_FINISH = 'add_person_with_default_coeff_finish'
